...
latex_documents = [
  ('index', 'format.tex', u'mesytec-mvlc documentation',
...
man_pages = [
    ('index', 'mesytec-mvlc', u'mesytec-mvlc documentation', [u'Florian Lüke'], 1)
]
...
texinfo_documents = [
  ('index', 'mesytec-mvlc', u'mesytec-mvlc documentation',
   u'Florian Lüke', 'mesytec-mvlc', 'One line description of project.',
   'Miscellaneous'),
]
